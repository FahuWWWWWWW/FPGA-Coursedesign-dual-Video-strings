...
#
# Script generated by Vivado on Sun Dec 07 13:02:25 +0800 2025
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="A:/FPGA/Vivado/A7/K9_F407/example/40_ov5640_hdmi/prj/ov5640_hdmi.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
