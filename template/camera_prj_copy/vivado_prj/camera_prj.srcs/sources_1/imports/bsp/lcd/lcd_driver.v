...
module lcd_driver(
    ...
    output             frame_sync,   // [NEW] 内部场同步信号 (用于FIFO复位同步)
...
// [NEW] 生成真实的垂直同步信号 (Active High Pulse, 对应 cnt_v < v_sync)
// 即使 lcd_vs 端口为1, 这个信号用于内部逻辑同步
assign frame_sync = (cnt_v < v_sync) ? 1'b1 : 1'b0;
