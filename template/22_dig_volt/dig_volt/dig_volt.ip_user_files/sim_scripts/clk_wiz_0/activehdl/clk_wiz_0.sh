...
#
# Script generated by Vivado on Fri Jan 02 15:16:26 +0800 2026
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="A:/FPGA_Project/FPGA_CourseDesign/22_dig_volt/dig_volt/dig_volt.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
