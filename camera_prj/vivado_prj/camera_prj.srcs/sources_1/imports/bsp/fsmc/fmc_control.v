module fmc_control(
    ...
    inout  [15:0] fpga_db,			//	双向地址/数据总线
	 ...
	 input  [15:0] write_data_16,	// FPGA  -> STM32 通道16
	 input  [15:0] write_data_17,	// FPGA  -> STM32 通道17
	 input  [15:0] write_data_18,	// FPGA  -> STM32 通道18
	 input  [15:0] write_data_19,	// FPGA  -> STM32 通道19
	...
	if(!rst)
		...
		begin
			case(addr)
				...
				16'h0010: rd_data_reg <= write_data_16;
				16'h0011: rd_data_reg <= write_data_17;
				16'h0012: rd_data_reg <= write_data_18;
				16'h0013: rd_data_reg <= write_data_19;
			endcase
		end
end
