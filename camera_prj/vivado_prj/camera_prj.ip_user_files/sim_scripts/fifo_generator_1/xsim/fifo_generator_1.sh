...
#
# Script generated by Vivado on Sat Jan 03 00:52:25 +0800 2026
...
export RDI_DATADIR="A:/Vivado/XILINX/2025.1/Vivado/data"
...
# script info
echo -e "fifo_generator_1.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L fifo_generator_v13_2_13 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot fifo_generator_1 xil_defaultlib.fifo_generator_1 xil_defaultlib.glbl -log elaborate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="A:/Vivado/XILINX/2025.1/Vivado/data/xsim"
  fi
